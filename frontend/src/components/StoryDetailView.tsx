...
export function StoryDetailView({ title, path, onFork, onBack, onToggleTree, showTree }: StoryDetailViewProps) {
  return (
        ...
        <div className="mb-12 text-center space-y-6">
          ...
          <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                 <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 hover:bg-secondary text-secondary-foreground transition-colors group">
                    <Heart className="w-4 h-4 group-hover:fill-current group-hover:text-red-500 transition-colors" />
...
function StoryLine({ node, index, onFork }: StoryLineProps) {
  ...
  const [likeCount, setLikeCount] = useState(node.likes || 0);
